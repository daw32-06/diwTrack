...
<body onload="inicio()" cz-shortcut-listen="true">
    ...
    <div id="menuizq">
        ...
        <div id="usuarioElem">
            ...
            <div id="opciones">
                <ul>
                    <div class="op"><a href="#"><li><img src="webroot/img/uploadTrack.png">Subir Track</li></a></div>
                    <div class="op"><a href="#"><li><img src="webroot/img/stats.png">Ver estadisticas</li></a></div>
                    <div class="op"><a href="#"><li><img src="webroot/img/settings.png">Configuración</li></a></div>
                    <div class="op"><a href="index.php?location=logoff"><li><img src="webroot/img/logout.png">Cerrar Sesion</li></a></div>
                </ul>
            </div>
